	...
	public function showPagination(){
		...
		if($this->_totalPage > 1){
			...
			if($this->_currentPage > 1){
                $start 	= "<li class='pagination_item'><a class='pagination_item_link' href='$actual_link/1'>Đầu</a></li>";
				$prev 	= "<li class='pagination_item'><a class='pagination_item_link' href='$actual_link/".($this->_currentPage-1)."'>«</a></li>";
            }
            
			$next 	= ''; 
			$end 	= ''; 
			if($this->_currentPage < $this->_totalPage){
				$next 	= "<li class='pagination_item'><a class='pagination_item_link' href='$actual_link/".($this->_currentPage+1)."'>»</a></li>";
				$end 	= "<li class='pagination_item'><a class='pagination_item_link' href='$actual_link/".$this->_totalPage."'>Cuối</a></li>";
			}
			...
			for($i = $startPage; $i <= $endPage; $i++){
				if($i == $this->_currentPage) {
					$listPages .= "<a class='item-pagination flex-c-m trans-0-4 active-pagination'>".$i."</a>";
				}
				else{
					$listPages .= "<a class='item-pagination flex-c-m trans-0-4' href='$actual_link/".$i."'>".$i.'</a>';
				}
			}
			$paginationHTML = '<div class="pagination flex-m flex-w p-t-26">'.$prev.$listPages.$next.'</div>';
		}
